...
configs=(
    ...
    "coffee-button-v2-goal-observable,plate-slide-v2-goal-observable"
    "coffee-button-v2-goal-observable,plate-slide-side-v2-goal-observable"
)
...
do
    ...
    cmd="python train_jsrl_curriculum_multi_task.py --sparse=True --guide_env=$guide_env --student_env=$student_envs --timesteps=500000 --seed=2"
